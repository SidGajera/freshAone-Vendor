  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title:
              Text("Cancelled", style: headline1ExtraLarge(context: context)),
        ...
        body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
          stream: FirebaseFirestore.instance
              ...
              .where("orderRejected", isEqualTo: true)
...
class Readybody extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final items = snapshot.data()["order"];
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    snapshot.data()['orderedOn'].toString(),
