...
class ShippedScrn extends StatefulWidget {
  static String routeName = '/ShippedScrn';
  const ShippedScrn({Key? key}) : super(key: key);

  @override
  State<ShippedScrn> createState() => _ShippedScrnState();
}

class _ShippedScrnState extends State<ShippedScrn> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text("Shipped", style: headline1ExtraLarge(context: context)),
