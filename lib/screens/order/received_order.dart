...
class ReceivedoderScrn extends StatefulWidget {
  static String routeName = '/ReceivedoderScrn';
  const ReceivedoderScrn({Key? key}) : super(key: key);

  @override
  State<ReceivedoderScrn> createState() => _ReceivedoderScrnState();
}

class _ReceivedoderScrnState extends State<ReceivedoderScrn> {
        ...
        appBar: AppBar(
          ...
          title: Row(
            ...
            children: [
              ...
              //   width: 79,
              // ),
              Text("Received", style: headline1ExtraLarge(context: context)),
              const Icon(
                Icons.search,
                color: primary,
              ),
                                    ...
                                    MaterialButton(
                                      ...
                                      onPressed: () async {
                                        await Provider.of<FirebaseOperation>(
                                                context,
                                                listen: false)
                                            .readyOrder(snapshot.id);
                                      },
                                      color: const Color(0xfff2FA84E),
